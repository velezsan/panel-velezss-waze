...
ALLOWED = {
    ...
    # novena tanda: lo que seguía saliendo en las dos cajas del panel; lo corto
    # y sin parecido a palabra se queda en mayúsculas
    ".A.C", "A.M.A.", "AAME", "AAT", "ABACO", "ABCA", "ABR", "ABTS", "ACUA", "AD", "ADC",
    "ADI", "ADO", "AE", "AEDI", "AEP", "AFI", "AFN", "AFX", "AGAPI", "AGL", "AIE", "AIS",
    "AKA", "AKY", "ALL", "ALTUM", "AMC", "AMM.CO", "AMMCO", "ANSA", "API", "APT", "APU",
    "ARA", "ARC", "ARDIN", "ARM", "ARTSA", "ASB", "ASEBC", "ASEM", "ATASA", "ATISA", "AU",
    "AUMA", "AUS", "AVC", "AVIT", "AXPE", "B.B.Q", "B.C", "B.I.", "BAE", "BALO", "BATSA",
    "BBB", "BCN", "BCS", "BD", "BI", "BII", "BJAM", "BJC", "BJM", "BJO", "BLT", "BMP",
    "BNB", "BOE", "BOH", "BOL", "BORM", "BREG", "BROX", "BSC", "BSI", "BTI", "BVI", "BVP",
    "BWI", "C&SI", "C.A.P.P.I.", "C.C.", "C.E.M.Q.", "C.N.O.P.", "C.P:", "C.R.",
    "C.R.E.E.", "C.R.E.I", "C.T.M.", "CAAPS", "CADER", "CAFV", "CAIC", "CAIPE", "CALP",
    "CAMUR", "CAPEP", "CBM", "CCIE", "CCSI", "CD", "CD.", "CDA", "CDHI", "CEB", "CECAN",
    "CECEM", "CECSO", "CECUT", "CEDIF", "CEJUM", "CEMUT", "CEPIE", "CESIT", "CESPE",
    "CESSA", "CET", "CETTO", "CETYS", "CEUNI", "CEUNO", "CEWS", "CF", "CIAD", "CIB",
    "CICAN", "CIDEC", "CIDUE", "CIEF", "CIFAC", "CIJ", "CIM", "CIRD", "CITV", "CIVS",
    "CIX", "CJS", "CK", "CLEM", "CMB", "CMG", "CMI", "CMIC", "CNA", "CNN", "CO.", "COBAO",
    "CODET", "COEL", "COES", "COFAT", "COI", "COITA", "COM", "COVIA", "COX", "CQI",
    "CREAD", "CRI", "CRODE", "CRU", "CSA", "CSON", "CST", "CTS", "CTUM", "CUES", "CUME",
    "CUVE", "CV.", "CVG", "CYA", "CYSIT", "D'PAUL", "D.A.R.E", "D.J.I.S.C.", "DAHER",
    "DASHA", "DAX", "DC", "DCH", "DCN", "DDAM", "DDR", "DEGA", "DELSA", "DESOM", "DF",
    "DGCFT", "DI", "DIBA", "DIS", "DJO", "DMC", "DOAL", "DOC", "DPI", "DTR", "D´PAUL",
    "E.E.U.U.", "E.P.", "EBEN", "ECBER", "ECI", "ECO", "EDS", "EKT", "ELIM", "EM", "EMDEP",
    "EME", "EMWA", "EMY", "EMYS", "ENA", "EORM", "EOUMN", "EPS", "ERS", "ESAV", "ESJ",
    "ESON", "EST", "ETM", "EUA", "EV", "EVCO", "EVO", "EYS", "EYSA", "EZER", "F.N.S.I.",
    "FAC", "FAM", "FANAL", "FANE", "FCCF", "FCH", "FCQI", "FDM", "FEBRA", "FEIM", "FEMAP",
    "FGA", "FGE", "FGJE", "FIH", "FIMSA", "FIT", "FLO", "FMI", "FMX", "FOXXX", "FRACC.",
    "FSTSE", "FTA", "FYPSA", "FYSA", "GABAL", "GAC", "GAFF", "GAREN", "GASCO", "GCC",
    "GECE", "GER", "GG", "GHC", "GIL", "GIMSA", "GJV", "GKN", "GL", "GOCOZ", "GPA", "GPE",
    "GPS", "GSM", "GTO", "GUB", "GUERO", "HDZ", "HE", "HEJSA", "HERLO", "HESC", "HGOMF",
    "HGPMF", "HHI", "HHR", "HIES", "HIMES", "HK", "HLB", "HNT", "HOMMI", "HOORO", "HPS",
    "HRP", "HS", "HT", "HUX", "I.A.", "I.A.P", "IAASE", "IADA", "IAN", "IB", "IBK", "ICB",
    "ICBC", "ICCS", "ICES", "ICEST", "ICL", "ICSA", "ICT", "ID", "IDEC", "IDU", "IEA",
    "IEBO", "IEBSA", "IECA", "IEM", "IGB", "IGSS", "IIDE", "IIES", "IIMSA", "IIS", "IIT",
    "IK", "IMDET", "IMER", "IMMM", "IMMS", "INA", "INAM", "INBE", "INC.", "INEB", "INECC",
    "INEDI", "INGCO", "INIDE", "INM", "INN", "INT", "ION", "IPCO.", "IPS", "IPSUM", "IQOR",
    "IRC", "IRNE", "ISAD", "ISH", "ISIMA", "ITAES", "ITAMA", "ITCC", "ITH", "ITSA",
    "ITSMZ", "ITT", "IUX", "IVANO", "IZI", "J.N.", "JA", "JAD", "JAM", "JAS", "JFE", "JHS",
    "JMAS", "JOLI", "JOY", "JPJ", "JPP", "JUDCO", "JUFRA", "JYM", "KATAI", "KIN", "KLM",
    "KN", "KOBBI", "KOSHY", "KPMG", "KR", "KRL", "KRS", "KST", "KY", "KYM", "LAM", "LAPAS",
    "LARA'S", "LASSA", "LAT", "LCWIL", "LDS", "LEC", "LGA", "LGO", "LH", "LI", "LIC.",
    "LISAN", "LIV", "LLASA", "LMI", "LMT", "LNT", "LO", "LOF", "LOLAS", "LOREM", "LOV",
    "LOYA", "LQ", "LSDD", "LU", "LUMI", "LYPRO", "MA", "MA.", "MADV", "MAFRA", "MAGUL",
    "MAGÓN", "MAT", "MAYCO", "MAYRE", "MB", "MB&A", "MBG", "MC.", "MCI", "MCP", "MCS",
    "MDD", "MDE", "MDF", "MDS", "MEAPO", "MEM", "MERCO", "METL", "MGB", "MIXUP", "MJR",
    "MKS", "MMCC", "MMCD", "MMSG", "MNES", "MOM'S", "MOY", "MPA", "MPH", "MPS", "MQC",
    "MR.", "MRD", "MRK", "MRTC", "MSC", "MSM", "MSO", "MSST", "MTZ.", "MUA", "MVS", "MVZ",
    "MWC", "MXL", "MXLI", "MXOE", "MXS", "NA", "NABEL", "NAP", "NAS", "NASE", "NCH", "NCI",
    "NEWEN", "NF", "NHI", "NIASA", "NLD", "NLM", "NN", "NOÉ", "NSG", "NUM.", "NUT.",
    "NUVU", "NW", "NYR", "OCC", "OCID", "OCOS", "ODEM", "ODENT", "ODU", "OGAZ", "OH",
    "OIM", "OLB", "OLD", "OMU", "OP", "OPA", "ORBEX", "ORICA", "OSI", "OSP", "OSV", "OTAY",
    "OTEZ", "PACAR", "PAF", "PAKAL", "PAM", "PAMSA", "PATSA", "PAVSA", "PCE", "PCH", "PDS",
    "PEC", "PEDSA", "PEKES", "PEMM", "PEN", "PEST", "PET", "PETS", "PI", "PIBO", "PIMS",
    "PIP", "PJBC", "PJI", "PKC", "PL", "PL.", "PLD", "PLR", "PNM", "POMET", "POWIZ", "PPA",
    "PPE", "PPG", "PROIN", "PSN", "PSX", "PTR", "PV", "PVFI", "PVIF", "PWC", "PXM", "QROO",
    "QUIKE", "R.C", "R.C.", "R.S", "R.S.", "R.V.", "RACSA", "RAN", "RB", "RBC", "RCB",
    "RENAP", "REV", "REX", "RGTO.", "RHD", "RHT", "RIVI", "RL.", "RMH", "RN", "ROZCH",
    "RSI", "S.A..", "S.A.B", "S.C", "S.I.", "S.L.", "S.O.P.", "S.P.A.", "SABC", "SACV.",
    "SADI", "SAPAM", "SARH", "SBC", "SBL", "SCH", "SCLC", "SCX", "SDG", "SDL",
    "SDN", "SEC", "SEDEM", "SEECH", "SEI", "SEJAP", "SEM", "SENSA", "SEUAT", "SFH",
    "SHENY", "SIDUR", "SIIL", "SILZA", "SISAA", "SITT", "SJHT", "SLRC", "SMC", "SMI",
    "SMK", "SMTC", "SOGO", "SOI", "SPAYT", "SPK", "SPR", "SQ", "SSA", "STAUS", "STIX",
    "STT", "SUCUM", "T.G.I.", "TAA", "TADI", "TAES", "TAG", "TAI", "TAO", "TAR", "TAZ",
    "TBC", "TBJ", "TC", "TCD", "TCL", "TCS", "TCT", "TDE", "TDM", "TECUN", "TEE", "TEK",
    "TF", "TFM", "TFW", "TGI", "TGM", "TIJ", "TILE", "TK", "TKR", "TKT", "TLC", "TMM",
    "TMMBC", "TN", "TNL", "TOLSÀ", "TOMZA", "TOTEC", "TOY", "TPV", "TRN", "TRW", "TSE",
    "TSJE", "TUTYS", "U.A.B.C.S", "U.G.R.S.", "U.H.", "U.M.F.N", "UABJO", "UCAN", "UDAH",
    "UDC", "UDM", "UDS", "UEEP", "UES", "UFM", "UHM", "UIS.", "UMAN", "UMR", "UNACH",
    "UNCOS", "UNERA", "UNT", "UNUS", "UP.", "UPBC", "UPM", "UPN", "URBI", "URN", "URSA",
    "UT", "UTC", "UTCJ", "UTH", "UTRGV", "UTTN", "UVG", "VET", "VH", "VIA", "VIGIA",
    "VIOP", "VIPAL", "VIRI", "VIS", "VITTA", "VIV", "VIVRI", "VK", "VP", "VR", "VS", "VSH",
    "VSM", "VW&MAN", "VYO", "WDF", "XB", "XEDP", "XERSA", "XHAHU", "XHCDH", "XIV", "XIX",
    "YAZ", "YI", "YM", "YMAR", "YULI", "Z'CRUZ", "ZNAK", "ZOAR", "ZUART",
}

# Categorías que en el mapa deben ir como área y no como punto: la gasolinera,
# el estacionamiento y el aeropuerto ocupan un polígono, y de punto quedan mal
# dibujados y mal enrutados.
DEBEN_SER_AREA = {"GAS_STATION", "PARKING_LOT", "AIRPORT"}


def es_punto_que_debe_ser_area(cats, area):
    """¿Es de las categorías que piden área y está puesto como punto?"""
    return bool(cats) and not area and any(c in DEBEN_SER_AREA for c in cats)
...
KEEP_AS_IS = [
    ...
    "ViveBús",
    # novena tanda: marcas y nombres con forma propia
    "#My", "''Ing.", "+Bara", "24Hrs.", "3Boys", "3Dent", "5Elementos", "7Eleven",
    "Abts.CORONA", "Abts.EL", "Abts.GLORIA", "Abts.GUERRERO", "Abts.MARGARITA",
    "Abts.RINCONADA", "Abts.SUPER", "Abts.VIRGEN", "AgroDelta", "AgroEquipos",
    "AgroFertilizantes", "AppleBees", "ArqCOM", "ArquiStudio", "AscoTech", "AtlasProfilax",
    "AutoMax", "AutoMecánica", "AutoPartes", "AutoStar", "AutoTrans", "AutoTransporte",
    "BAires", "BajaMed", "BamBam", "BanBanjio", "BaseBall", "BellaVista", "BendiksenLaw*",
    "BetcrisHillo", "BipGas", "BlackWood", "BooBar", "BoriPan", "BurgerKing", "C.B.T.i.s",
    "CANO's", "CBTa", "CBeTIS", "CBtis", "CECyTEs", "CECyTe", "CEDis", "CETIs", "CETis",
    "CIGoM", "CIbanco", "CNyN", "CadToner", "CaliBaja", "CampoJjaime", "CandyBar",
    "CapillaSanta", "Carn.EL", "CarniceríaJessica", "CasaSpa", "CastNutrition", "CeMIE",
    "CecyTec", "CineMall", "CircuitHOME", "CitiBanamex", "CoDental", "CoWorking120",
    "ColMex", "ComeCamila", "CommScope", "CompartamosBanco", "CompuCentro", "CompuDisc",
    "CompuFix", "ConCredito", "ConMed", "CopaCabana", "CopiK", "CowBoy", "CrehTE", "DHGas",
    "DPriza", "DeConcini", "DeVolada", "DentAll", "DentaLA", "DentalLife", "DermaClub",
    "DiesGas", "DigiControl", "DisFrutaMás", "Dist.HANZEL", "DiverSNTE", "DogLover",
    "DogoTOTE", "Dr.Wong", "D´Martlub", "D’Alicia", "D’Arteaga", "D’Gala", "D’Javier",
    "D’Lachi", "D’Monica", "ELight", "ESi08401", "ETech", "EcoGas", "EcoParque",
    "EcomiLed", "EconoTaxi", "EliteAudio", "EmbryoGen", "EquiBaja", "ExpoGan", "ExpreZion",
    "FOXPloration", "FarmaCon", "FerroAgro", "FerroMex", "FinYa", "FixUp",
    "Frut.FRANCISCO", "FyPSA", "GGTrailers", "GasAuto", "GasCo", "GasPasa", "GasroNora",
    "GastroMed", "GeO", "GecVac", "GeneBac", "GoFast", "GobBC", "GonGas", "GongGas",
    "GraficAR", "GrupoISA", "GuauGuau", "HidroGas", "HighSq.", "HighTtech", "HomeStore",
    "HotDogería", "IHop", "INFONAVIt", "IOn", "ImpreFast", "InstaDent", "InterAmericana",
    "InterCeramic", "InterJeans", "InterPlaza", "JJ's", "JRendon", "JingWah", "KarzoGas",
    "KeBURROS", "KeBurros", "KinesioMed", "KofC", "KoolKidz", "KyA", "LCh", "LaBoutique",
    "LaSalle", "LavaLola", "LavaPro", "LeyvaGas", "LibroMex", "LingoStars", "MArket",
    "MGFisiobienestar", "MRSolutions", "MaVi", "MacroPlaza", "MadO", "MadaMarket",
    "MagoLand", "MamaMia", "MariaBonita", "MasterFuel", "MatCO", "MaxiClean", "McCain",
    "McDental", "McDonalds", "Mdo.DON", "Mdo.LA", "Mdo.NAJERA", "MecraMotors", "MedVet",
    "MediCan", "MediExcel", "MediMéxico", "MegaPan", "MegaPlast", "MercaChina", "MexLog",
    "MigueI", "MiniMarket", "MiraYork", "MotorZone", "MoveR", "MuscleFit", "MyVet",
    "MyaSalon", "NEOTech", "Na’Vicenta", "NeuroEstable", "NewCity", "NiñosMelchor",
    "NovaMed", "NovoFut", "OK2Charge", "OKCar4rent", "OReilly", "OfiMuebles", "OficeMart",
    "OldTJ", "OneSource", "OpenAG", "OptiVISTA", "OrAn", "OrthoRehab", "OyS", "PaintBall",
    "PanLuna", "PanaderÍa", "PeluKids", "PensionISSSTE", "PepsiCo", "PeriSur", "Pet'sMed",
    "PickBar", "PickUp", "PinkaBlooh", "PitBox", "PizzaBoy", "PizzaSon", "PremiumDent.",
    "PrendaMex", "PrimusLabs", "PrintCo", "ProAgro", "ProSolutions", "ProVet", "PromoMex",
    "Pt.MaxMart", "QualityPost", "QueRollo", "QuintoTulio", "R.De", "R.L.de", "RapiWash",
    "ReTa", "RealFood", "RedCo", "RedPetroil", "RefaGas", "RefreSnack", "RegalRexnord",
    "RendiChicas", "ReparaCar", "ReyLin", "RicheR", "RoCoos", "RockTenn", "RollerPark",
    "RollerRock", "SAM's", "SNTEnario", "SantoNiño", "ScarletRegina", "ServiGAS", "ShugÜ",
    "Sketch3Dmx", "SkyWorks", "SmartFit", "SmileBar", "SportBar", "StarGas", "StarTickets",
    "SuBodega!", "SumiNorte", "SunDeli", "SunMart", "SunRoll", "SuperISSSTE", "SuperLey",
    "SuperMarket", "SuperOxxo", "SurtAC", "SweetPlace", "TCm", "TITO's", "TJFitness",
    "TTelectronics", "TabColor", "TacoH", "TecNM", "TecnoParque", "TeleBachillerato",
    "TenChickenWaffles", "TerraSal", "TikTok", "TiresShop", "TopCar", "TopSkin",
    "TotalGAS", "TotalMedia", "TransGo", "TransPak", "TransUrge", "TresGuerras",
    "TruckMovers", "Twins+Patrick", "TyP", "TyrePlus", "UdeM", "UltraGym", "UnderGym",
    "UniFemme", "UvXpress", "UvaUva", "VGali", "VRed", "VaGa", "VellaSR", "VelvetRoses",
    "VentAcero", "VetCo", "VillaAnimal", "VillaSol", "VivaAerobús", "ViveBus", "ViveBuús",
    "VolksWagen", "WINPC's", "WeltAuto", "WeltAuto.", "WestRockers", "WildTj", "WingStop",
    "WowPizza", "XPert", "XxX", "YoMero", "ZincMaster", "ZuKsa", "cCramelo", "deMexico",
    "delAmbar", "eControl", "elMillón", "ez4U", "familia.Ramiirez", "firtsCash",
    "herrajesIgra", "iDigital", "iExplore", "iHop", "iLock", "iPistilli", "iQS", "iUDM",
    "uVicate", "¡I'iñor!", "¨Rosma", "“Victor",
]
...
RESPETAR_FORMA = {"km", "kms",
                  ...
                  # novena tanda: ni claramente sigla ni claramente palabra
                  "@work", "agora", "agro", "akron", "alamo", "alden", "allo", "ancla",
                  "atmos", "avis", "boss", "bull", "cala", "cami", "ceci", "cedo", "cell",
                  "cepa", "ceta", "chopo", "chubb", "cias", "cnte", "cocos", "cota",
                  "dali", "damn", "deco", "dela", "dico", "doña", "dual", "eaton", "elia",
                  "emcee", "esti", "fair", "fedex", "fiat", "fira", "flex", "fuel",
                  "garza", "graf", "imac", "imax", "infra", "istmo", "jade", "jong",
                  "katy", "lane", "lauro", "leoni", "lora", "lucia", "lucio", "maki",
                  "marla", "mejia", "meza", "midas", "mila", "monge", "movi", "musa",
                  "napa", "nelly", "niño", "novo", "ojeda", "orbis", "padel", "paola",
                  "patty", "pavon", "petco", "poly", "puma", "ramon", "rams", "rape",
                  "raúl", "rece", "reyno", "riga", "rios", "romo", "rosso", "ruben",
                  "ruby", "ríos", "sandi", "sears", "serna", "sete", "shea", "sica",
                  "sisa", "sorbo", "susy", "tacna", "tech", "tello", "town", "ulloa",
                  "vado", "wong", "xxii", "“meño”",}
...
NO_SON_SIGLAS = {
    ...
    # novena tanda: palabras y nombres de pila a gritos, y dedazos del tipo
    # "EStacionamiento"
    "AGUA", "AGimnasia", "ALMAS", "ALTO", "ALumnos", "AMAR", "ANDY", "ANGLO", "AULAS",
    "AVES", "AVILA", "BAJA", "BALLS", "BAR", "BARCO", "BELLA", "BEST", "BETTY", "BLUE",
    "BOOM", "BOOTS", "BUEN", "CAE", "CAFE", "CALI", "CANO", "CARGO", "CASE", "CLEAN",
    "COBRE", "COCA", "COCO", "COLA", "COLÓN", "CREA", "CUmbres", "DAMAS", "DEPOT", "DIOS",
    "DIOSA", "DRIVE", "EStacionamiento", "FARMS", "FELIX", "FINCA", "FIesta", "FORD",
    "FRAY", "FÉLIX", "GASES", "HIpodromo", "HORNO", "HOTEL", "INDEX", "JAIME", "JARA",
    "JESÚS", "JORGE", "JOSÉ", "JOYA", "JULIA", "JUNTA", "JUSTO", "KING", "LAGOS", "LEY",
    "LILY", "LLantera", "LOCAL", "LOLA", "LOPEZ", "LUIS", "LUZ", "LÓPEZ", "MAGNA", "MAR",
    "MARY", "MARZO", "MARÍA", "MAYOR", "MAría", "MEGA", "MILAN", "MINA", "MINI", "MITO",
    "MIscelánea", "MIsión", "MONTE", "MUNDO", "NIÑA", "NUEVO", "ORTIZ", "PARRA", "PATIO",
    "PEREZ", "PERLA", "PEÑA", "PIZZA", "PInto", "PLANT", "PLAY", "PLAZA", "PODER", "PRESA",
    "PRINT", "PRches", "PÉREZ", "RAMOS", "RAYOS", "READY", "REAL", "RED", "REINO", "REYES",
    "ROCA", "ROJA", "ROJAS", "RUIZ", "RURAL", "SALON", "SEMI", "SHELF", "SIMON", "SIN",
    "SMART", "SOL", "SOUND", "SPORT", "STEPS", "STORE", "STRIP", "SUPER", "SUR", "TERRA",
    "TIjuana", "TONY", "TOOLS", "TOROS", "TRATE", "TRES", "ULTRA", "UNICO", "UNION",
    "USOS", "VALEN", "VALLE", "VEGAS", "VIDA", "VILLA", "VIUDA", "VIVA", "WALL",
}
